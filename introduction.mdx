...
description: "GPT Project Skill System adds a skill-package workflow to ChatGPT Projects. Package skills as ZIPs, mount only what you need, keep every session focused."
---
