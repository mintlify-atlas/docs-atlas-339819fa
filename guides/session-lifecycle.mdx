...
description: "Understand the full lifecycle of a GPT Project Skill System session: boot the core, load skills, manage focus changes, and know when to start a new chat."
---
