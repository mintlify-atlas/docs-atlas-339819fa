---
title: "Path rules, ZIP entry requirements, and slug pattern"
sidebarTitle: "Path Rules"
description: "Safe relative path definition, core and skill path policy differences, ZIP entry separator rules, and the slug pattern for skill names."
---
