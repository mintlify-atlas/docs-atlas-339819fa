---
title: "Runtime limits, hard fails, and session scope"
sidebarTitle: "Runtime Limits"
description: "What the GPT Project Skill System deliberately does not provide: no hooks, persistent state, auto-routing, or dependency install. Covers hard fail and degraded load rules."
---
